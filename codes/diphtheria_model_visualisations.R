...
source("codes/new_diphtheria_model_functions.R")
...
# saveRDS(process_model_optimistic,"output/new/process_model_optimistic.rds")
# saveRDS(process_model_pessimistic,"output/new/process_model_pessimistic.rds")

process_model_optimistic <- readRDS("output/new/process_model_optimistic.rds")
process_model_pessimistic <- readRDS("output/new/process_model_pessimistic.rds")

p3 <- process_model_deterministic_plot(process_model_optimistic,times_of_observed,incidence_observed)
ggsave("figures/new/p3.jpg", ggdraw(p3),
       width = 16, height = 11, units = "cm")

p_pessimistic <- process_model_deterministic_plot(process_model_pessimistic,
                                                  times_of_observed,incidence_observed)
p_all_model <- plot_grid(ggdraw(p3),ggdraw(p_pessimistic),ncol=1,
                         labels=c("A","B"))
ggsave("figures/new/p_all_model.jpg", p_all_model,
...
# 
# saveRDS(output_model_without_ORI,"output/new/output_model_without_ORI.rds")
# saveRDS(output_model_without_CT,"output/new/output_model_without_CT.rds")
# saveRDS(output_model_delayed_ORI,"output/new/output_model_delayed_ORI.rds")

output_model_without_ORI <- readRDS("output/new/output_model_without_ORI.rds")
output_model_without_CT <- readRDS("output/new/output_model_without_CT.rds")
output_model_delayed_ORI <- readRDS("output/new/output_model_delayed_ORI.rds")
